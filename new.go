...
func NewLogsDatabase(
	...
	buildSumId, err = q.InsertBuildSumReturningID(
		ctx,
	...
	goVersionId, err = q.InsertGoVersionReturningID(
		ctx,
		&InsertGoVersionReturningIDParams{
			Name:    goVersion,
			Version: goVersion,
		},
	)
	...
	gitRevisionId, err = q.InsertGitRevisionReturningID(
		ctx,
	...
	deploymentId, err = q.InsertDeploymentReturningID(
		ctx,
